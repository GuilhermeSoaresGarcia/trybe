...
public record BookDTO(Long id, String title, String genre, BookDetails bookDetails, Publisher publisher) {

  public Book toBook() {
    return new Book(id, title, genre, bookDetails, publisher);
  }
}

...
SELECT COUNT(*) FROM rental WHERE DATE(return_date) = '2005-05-25';

SELECT COUNT(*) FROM rental WHERE return_date LIKE '2005-05-25%';

SELECT COUNT(*)
FROM rental
WHERE
    return_date BETWEEN '2005-05-25 00:00:00' AND '2005-05-25 23:59:59';
...
FROM payment
WHERE
    payment_date BETWEEN '2005-07-01 00:00:00' AND '2005-08-22 23:59:59';
